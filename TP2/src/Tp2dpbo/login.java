...
import static Tp2dpbo.dbConnection.stmt;
...
public class login extends javax.swing.JFrame {
 ...
 //   private dbConnection db;
    ...
    public login() {
        ...
        conn = (Connection) DriverManager.getConnection(ConAddress, user, passw);
    ...
    public boolean validate(String username, String password) {
       // boolean isValid = false;
        try {
        String sql = "SELECT * FROM password WHERE username = ? AND pass = ?";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pass = String.valueOf(jPasswordField1.getPassword());
             ...
             if (validate(usn, pass)) {
            JOptionPane.showMessageDialog(this, "Login successful, click OK to switch to the next page");
            this.dispose();
